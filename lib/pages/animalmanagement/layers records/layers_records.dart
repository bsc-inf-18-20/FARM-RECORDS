import 'package:farmrecord/pages/animalmanagement/layers%20records/layers_activity.dart';
import 'package:farmrecord/pages/animalmanagement/layers%20records/view_layers.dart'; // Ensure this import points to the correct 'ViewLayersPage'
import 'package:flutter/material.dart';

class LayersRecords extends StatefulWidget {
  const LayersRecords({super.key});

  @override
  _LayersRecordsState createState() => _LayersRecordsState();
}

class _LayersRecordsState extends State<LayersRecords> {
  ...
  void _navigateToAddActivity(BuildContext context) {
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              const LayersActivityPage()), // Updated to LayersActivityPage
    );
  }
  ...
  void _navigateToViewActivities(BuildContext context) {
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              const ViewLayers()), // Updated to ViewLayersPage
    );
  }
...
class LayersAppBar extends StatelessWidget implements PreferredSizeWidget {
